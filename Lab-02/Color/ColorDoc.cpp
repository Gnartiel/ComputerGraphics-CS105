...
void CColorDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CColorDoc::InitializeSearchContent()
{
...
void CColorDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
